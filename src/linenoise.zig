...
pub const struct_linenoiseState = extern struct {
    in_completion: c_int = 0,
    completion_idx: usize = 0,
    ifd: c_int = 0,
    ofd: c_int = 0,
    buf: [*c]u8 = null,
    buflen: usize = 0,
    prompt: [*c]const u8 = null,
    plen: usize = 0,
    pos: usize = 0,
    oldpos: usize = 0,
    len: usize = 0,
    ...
    oldrows: usize = 0,
    oldrpos: c_int = 0,
    history_index: c_int = 0,
    pub const linenoiseEditStart = __root.linenoiseEditStart;
    pub const linenoiseEditFeed = __root.linenoiseEditFeed;
    pub const linenoiseEditStop = __root.linenoiseEditStop;
    pub const linenoiseHide = __root.linenoiseHide;
    pub const linenoiseShow = __root.linenoiseShow;
};
pub const struct_linenoiseCompletions = extern struct {
    len: usize = 0,
    cvec: [*c][*c]u8 = null,
    pub const linenoiseAddCompletion = __root.linenoiseAddCompletion;
};
...
pub const linenoiseHintsCallback = fn ([*c]const u8, color: [*c]c_int, bold: [*c]c_int) callconv(.c) [*c]u8;
...
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /home/vitalii/.zvm/master/lib/compiler/aro/include/stddef.h:18:9
