// Generated by re2zig 4.3.1 on Tue Feb 10 10:27:03 2026
   ...
   loop: while(true) {
    ...
    yyl: while (true) {
        switch (yystate) {
            ...
            106 => { return .{ .id = .unquote_splicing,   .start = start, .end = yyrecord.yycursor}; },
            107 => {
                yych = yyrecord.yyinput[yyrecord.yycursor];
                switch (yych) {
                    0x30...0x39 => {
            ...
            110 => { return .{ .id = .floatNumber, .start = start, .end = yyrecord.yycursor}; },
            111 => {
                yych = yyrecord.yyinput[yyrecord.yycursor];
                switch (yych) {
                    0x2B,
            ...
            339 => { return .{ .id = .unsyntax_splicing,   .start = start, .end = yyrecord.yycursor}; },
            340 => {
                yystate = 341;
                continue :yyl;
            },
            341 => { return .{ .id = .character, .start = start, .end = yyrecord.yycursor}; },
            342 => {
                yyaccept = 7;
                yyrecord.yymarker = yyrecord.yycursor;
                yych = yyrecord.yyinput[yyrecord.yycursor];
            ...
            499 => { return .{ .id = .character, .start = start, .end = yyrecord.yycursor}; },
            500 => {
                yych = yyrecord.yyinput[yyrecord.yycursor];
                switch (yych) {
                    0x65 => {
            ...
            501 => { return .{ .id = .character, .start = start, .end = yyrecord.yycursor}; },
            502 => { return .{ .id = .eof, .start = start, .end = yyrecord.yycursor}; },
